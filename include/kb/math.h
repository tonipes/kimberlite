...
KB_API_INLINE kb_int2      kb_int2_add          (const kb_int2 a, const kb_int2 b)                 { return (kb_int2) ELEMWISE_OP2_T2(kb_int_add); }
KB_API_INLINE kb_int2      kb_int2_sub          (const kb_int2 a, const kb_int2 b)                 { return (kb_int2) ELEMWISE_OP2_T2(kb_int_sub); }
KB_API_INLINE kb_int2      kb_int2_mul          (const kb_int2 a, const kb_int2 b)                 { return (kb_int2) ELEMWISE_OP2_T2(kb_int_mul); }
KB_API_INLINE kb_int2      kb_int2_div          (const kb_int2 a, const kb_int2 b)                 { return (kb_int2) ELEMWISE_OP2_T2(kb_int_div); }
KB_API_INLINE kb_int2      kb_int2_min          (const kb_int2 a, const kb_int2 b)                 { return (kb_int2) ELEMWISE_OP2_T2(kb_int_min); }
KB_API_INLINE kb_int2      kb_int2_max          (const kb_int2 a, const kb_int2 b)                 { return (kb_int2) ELEMWISE_OP2_T2(kb_int_max); }
KB_API_INLINE kb_int       kb_int2_dot          (const kb_int2 a, const kb_int2 b)                 { return ELEMWISE_COMB_OP2_T2(kb_int_mul, +); }
KB_API_INLINE bool         kb_int2_equal        (const kb_int2 a, const kb_int2 b)                 { return ELEMWISE_COMB_OP2_T2(kb_int_equal, &&); }
KB_API_INLINE kb_int2      kb_int2_scale        (const kb_int2 a, const kb_int f)                  { return (kb_int2) ELEMWISE_OP1_F_T2(kb_int_mul, f); }
KB_API_INLINE kb_int2      kb_int2_neg          (const kb_int2 a)                                  { return (kb_int2) ELEMWISE_OP1_T2(kb_int_neg); }
KB_API_INLINE kb_int2      kb_int2_abs          (const kb_int2 a)                                  { return (kb_int2) ELEMWISE_OP1_T2(kb_int_abs); }
KB_API_INLINE float        kb_int2_len          (const kb_int2 a)                                  { return kb_float_sqrt(kb_int2_dot(a, a)); }
KB_API_INLINE kb_int2      kb_int2_sign         (const kb_int2 a)                                  { return (kb_int2) ELEMWISE_OP1_T2(kb_int_sign); }
KB_API_INLINE kb_int2      kb_int2_square       (const kb_int2 a)                                  { return (kb_int2) ELEMWISE_OP1_T2(kb_int_square); }

KB_API_INLINE kb_int3      kb_int3_add          (const kb_int3 a, const kb_int3 b)                 { return (kb_int3) ELEMWISE_OP2_T3(kb_int_add); }
KB_API_INLINE kb_int3      kb_int3_sub          (const kb_int3 a, const kb_int3 b)                 { return (kb_int3) ELEMWISE_OP2_T3(kb_int_sub); }
KB_API_INLINE kb_int3      kb_int3_mul          (const kb_int3 a, const kb_int3 b)                 { return (kb_int3) ELEMWISE_OP2_T3(kb_int_mul); }
KB_API_INLINE kb_int3      kb_int3_div          (const kb_int3 a, const kb_int3 b)                 { return (kb_int3) ELEMWISE_OP2_T3(kb_int_div); }
KB_API_INLINE kb_int3      kb_int3_min          (const kb_int3 a, const kb_int3 b)                 { return (kb_int3) ELEMWISE_OP2_T3(kb_int_min); }
KB_API_INLINE kb_int3      kb_int3_max          (const kb_int3 a, const kb_int3 b)                 { return (kb_int3) ELEMWISE_OP2_T3(kb_int_max); }
KB_API_INLINE kb_int       kb_int3_dot          (const kb_int3 a, const kb_int3 b)                 { return ELEMWISE_COMB_OP2_T3(kb_int_mul, +); }
KB_API_INLINE bool         kb_int3_equal        (const kb_int3 a, const kb_int3 b)                 { return ELEMWISE_COMB_OP2_T3(kb_int_equal, &&); }
KB_API_INLINE kb_int3      kb_int3_scale        (const kb_int3 a, const kb_int f)                  { return (kb_int3) ELEMWISE_OP1_F_T3(kb_int_mul, f); }
KB_API_INLINE kb_int3      kb_int3_neg          (const kb_int3 a)                                  { return (kb_int3) ELEMWISE_OP1_T3(kb_int_neg); }
KB_API_INLINE kb_int3      kb_int3_abs          (const kb_int3 a)                                  { return (kb_int3) ELEMWISE_OP1_T3(kb_int_abs); }
KB_API_INLINE kb_float     kb_int3_len          (const kb_int3 a)                                  { return kb_float_sqrt(kb_int3_dot(a, a)); }
KB_API_INLINE kb_int3      kb_int3_sign         (const kb_int3 a)                                  { return (kb_int3) ELEMWISE_OP1_T3(kb_int_sign); }
KB_API_INLINE kb_int3      kb_int3_square       (const kb_int3 a)                                  { return (kb_int3) ELEMWISE_OP1_T3(kb_int_square); }

KB_API_INLINE kb_int4      kb_int4_add          (const kb_int4 a, const kb_int4 b)                 { return (kb_int4) ELEMWISE_OP2_T4(kb_int_add); }
KB_API_INLINE kb_int4      kb_int4_sub          (const kb_int4 a, const kb_int4 b)                 { return (kb_int4) ELEMWISE_OP2_T4(kb_int_sub); }
KB_API_INLINE kb_int4      kb_int4_mul          (const kb_int4 a, const kb_int4 b)                 { return (kb_int4) ELEMWISE_OP2_T4(kb_int_mul); }
KB_API_INLINE kb_int4      kb_int4_div          (const kb_int4 a, const kb_int4 b)                 { return (kb_int4) ELEMWISE_OP2_T4(kb_int_div); }
KB_API_INLINE kb_int4      kb_int4_min          (const kb_int4 a, const kb_int4 b)                 { return (kb_int4) ELEMWISE_OP2_T4(kb_int_min); }
KB_API_INLINE kb_int4      kb_int4_max          (const kb_int4 a, const kb_int4 b)                 { return (kb_int4) ELEMWISE_OP2_T4(kb_int_max); }
KB_API_INLINE kb_int       kb_int4_dot          (const kb_int4 a, const kb_int4 b)                 { return ELEMWISE_COMB_OP2_T4(kb_int_mul, +); }
KB_API_INLINE bool         kb_int4_equal        (const kb_int4 a, const kb_int4 b)                 { return ELEMWISE_COMB_OP2_T4(kb_int_equal, &&); }
KB_API_INLINE kb_int4      kb_int4_scale        (const kb_int4 a, const kb_int f)                  { return (kb_int4) ELEMWISE_OP1_F_T4(kb_int_mul, f); }
KB_API_INLINE kb_int4      kb_int4_neg          (const kb_int4 a)                                  { return (kb_int4) ELEMWISE_OP1_T4(kb_int_neg); }
KB_API_INLINE kb_int4      kb_int4_abs          (const kb_int4 a)                                  { return (kb_int4) ELEMWISE_OP1_T4(kb_int_abs); }
KB_API_INLINE kb_float     kb_int4_len          (const kb_int4 a)                                  { return kb_float_sqrt(kb_int4_dot(a, a)); }
KB_API_INLINE kb_int4      kb_int4_sign         (const kb_int4 a)                                  { return (kb_int4) ELEMWISE_OP1_T4(kb_int_sign); }
KB_API_INLINE kb_int4      kb_int4_square       (const kb_int4 a)                                  { return (kb_int4) ELEMWISE_OP1_T4(kb_int_square); }

KB_API_INLINE kb_float2    kb_float2_abs        (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_abs); }
KB_API_INLINE kb_float2    kb_float2_neg        (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_neg); }
KB_API_INLINE kb_float2    kb_float2_floor      (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_floor); }
KB_API_INLINE kb_float2    kb_float2_add        (const kb_float2 a, const kb_float2 b)             { return (kb_float2) ELEMWISE_OP2_T2(kb_float_add); }
KB_API_INLINE kb_float2    kb_float2_sub        (const kb_float2 a, const kb_float2 b)             { return (kb_float2) ELEMWISE_OP2_T2(kb_float_sub); }
KB_API_INLINE kb_float2    kb_float2_mul        (const kb_float2 a, const kb_float2 b)             { return (kb_float2) ELEMWISE_OP2_T2(kb_float_mul); }
KB_API_INLINE kb_float2    kb_float2_min        (const kb_float2 a, const kb_float2 b)             { return (kb_float2) ELEMWISE_OP2_T2(kb_float_min); }
KB_API_INLINE kb_float2    kb_float2_max        (const kb_float2 a, const kb_float2 b)             { return (kb_float2) ELEMWISE_OP2_T2(kb_float_max); }
KB_API_INLINE kb_float2    kb_float2_scale      (const kb_float2 a, const kb_float f)              { return (kb_float2) ELEMWISE_OP1_F_T2(kb_float_mul, f); }
KB_API_INLINE kb_float2    kb_float2_recip      (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_recip); }
KB_API_INLINE kb_float2    kb_float2_lerp       (const kb_float2 a, const kb_float2 b, const kb_float v) { return (kb_float2) ELEMWISE_OP2_F_T2(kb_float_lerp, v); }
KB_API_INLINE kb_float2    kb_float2_saturate   (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_saturate); }
KB_API_INLINE kb_float2    kb_float2_smoothstep (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_smoothstep); }
KB_API_INLINE kb_float2    kb_float2_square     (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_square); }
KB_API_INLINE kb_float2    kb_float2_exp        (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_exp); }
KB_API_INLINE kb_float2    kb_float2_log        (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_log); }
KB_API_INLINE kb_float2    kb_float2_sign       (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_sign); }
KB_API_INLINE kb_float2    kb_float2_sqrt       (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_sqrt); }
KB_API_INLINE kb_float2    kb_float2_frac       (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_frac); }
KB_API_INLINE kb_float2    kb_float2_ceil       (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_ceil); }
KB_API_INLINE kb_float2    kb_float2_round      (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_round); }
KB_API_INLINE kb_float2    kb_float2_trunc      (const kb_float2 a)                                { return (kb_float2) ELEMWISE_OP1_T2(kb_float_trunc); }
KB_API_INLINE kb_float     kb_float2_dot        (const kb_float2 a, const kb_float2 b)             { return ELEMWISE_COMB_OP2_T2(kb_float_mul, +); }
KB_API_INLINE bool         kb_float2_equal      (const kb_float2 a, const kb_float2 b)             { return ELEMWISE_COMB_OP2_T2(kb_float_equal, &&); }
...
KB_API_INLINE kb_float3    kb_float3_abs        (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_abs); }
KB_API_INLINE kb_float3    kb_float3_neg        (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_neg); }
KB_API_INLINE kb_float3    kb_float3_floor      (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_floor); }
KB_API_INLINE kb_float3    kb_float3_add        (const kb_float3 a, const kb_float3 b)             { return (kb_float3) ELEMWISE_OP2_T3(kb_float_add); }
KB_API_INLINE kb_float3    kb_float3_sub        (const kb_float3 a, const kb_float3 b)             { return (kb_float3) ELEMWISE_OP2_T3(kb_float_sub); }
KB_API_INLINE kb_float3    kb_float3_mul        (const kb_float3 a, const kb_float3 b)             { return (kb_float3) ELEMWISE_OP2_T3(kb_float_mul); }
KB_API_INLINE kb_float3    kb_float3_min        (const kb_float3 a, const kb_float3 b)             { return (kb_float3) ELEMWISE_OP2_T3(kb_float_min); }
KB_API_INLINE kb_float3    kb_float3_max        (const kb_float3 a, const kb_float3 b)             { return (kb_float3) ELEMWISE_OP2_T3(kb_float_max); }
KB_API_INLINE kb_float3    kb_float3_scale      (const kb_float3 a, const kb_float f)              { return (kb_float3) ELEMWISE_OP1_F_T3(kb_float_mul, f); }
KB_API_INLINE kb_float3    kb_float3_recip      (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_recip); }
KB_API_INLINE kb_float3    kb_float3_lerp       (const kb_float3 a, const kb_float3 b, const kb_float v)     { return (kb_float3) ELEMWISE_OP2_F_T3(kb_float_lerp, v); }
KB_API_INLINE kb_float3    kb_float3_saturate   (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_saturate); }
KB_API_INLINE kb_float3    kb_float3_smoothstep (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_smoothstep); }
KB_API_INLINE kb_float3    kb_float3_square     (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_square); }
KB_API_INLINE kb_float3    kb_float3_exp        (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_exp); }
KB_API_INLINE kb_float3    kb_float3_log        (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_log); }
KB_API_INLINE kb_float3    kb_float3_sign       (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_sign); }
KB_API_INLINE kb_float3    kb_float3_sqrt       (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_sqrt); }
KB_API_INLINE kb_float3    kb_float3_frac       (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_frac); }
KB_API_INLINE kb_float3    kb_float3_ceil       (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_ceil); }
KB_API_INLINE kb_float3    kb_float3_round      (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_round); }
KB_API_INLINE kb_float3    kb_float3_trunc      (const kb_float3 a)                                { return (kb_float3) ELEMWISE_OP1_T3(kb_float_trunc); }
KB_API_INLINE kb_float     kb_float3_dot        (const kb_float3 a, const kb_float3 b)             { return ELEMWISE_COMB_OP2_T3(kb_float_mul, +); }
KB_API_INLINE bool         kb_float3_equal      (const kb_float3 a, const kb_float3 b)             { return ELEMWISE_COMB_OP2_T3(kb_float_equal, &&); }
...
KB_API_INLINE kb_float4    kb_float4_abs        (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_abs); }
KB_API_INLINE kb_float4    kb_float4_neg        (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_neg); }
KB_API_INLINE kb_float4    kb_float4_floor      (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_floor); }
KB_API_INLINE kb_float4    kb_float4_add        (const kb_float4 a, const kb_float4 b)             { return (kb_float4) ELEMWISE_OP2_T4(kb_float_add); }
KB_API_INLINE kb_float4    kb_float4_sub        (const kb_float4 a, const kb_float4 b)             { return (kb_float4) ELEMWISE_OP2_T4(kb_float_sub); }
KB_API_INLINE kb_float4    kb_float4_mul        (const kb_float4 a, const kb_float4 b)             { return (kb_float4) ELEMWISE_OP2_T4(kb_float_mul); }
KB_API_INLINE kb_float4    kb_float4_min        (const kb_float4 a, const kb_float4 b)             { return (kb_float4) ELEMWISE_OP2_T4(kb_float_min); }
KB_API_INLINE kb_float4    kb_float4_max        (const kb_float4 a, const kb_float4 b)             { return (kb_float4) ELEMWISE_OP2_T4(kb_float_max); }
KB_API_INLINE kb_float4    kb_float4_scale      (const kb_float4 a, const kb_float f)              { return (kb_float4) ELEMWISE_OP1_F_T4(kb_float_mul, f); }
KB_API_INLINE kb_float4    kb_float4_recip      (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_recip); }
KB_API_INLINE kb_float4    kb_float4_lerp       (const kb_float4 a, const kb_float4 b, const kb_float v)     { return (kb_float4) ELEMWISE_OP2_F_T4(kb_float_lerp, v); }
KB_API_INLINE kb_float4    kb_float4_saturate   (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_saturate); }
KB_API_INLINE kb_float4    kb_float4_smoothstep (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_smoothstep); }
KB_API_INLINE kb_float4    kb_float4_square     (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_square); }
KB_API_INLINE kb_float4    kb_float4_exp        (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_exp); }
KB_API_INLINE kb_float4    kb_float4_log        (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_log); }
KB_API_INLINE kb_float4    kb_float4_sign       (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_sign); }
KB_API_INLINE kb_float4    kb_float4_sqrt       (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_sqrt); }
KB_API_INLINE kb_float4    kb_float4_frac       (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_frac); }
KB_API_INLINE kb_float4    kb_float4_ceil       (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_ceil); }
KB_API_INLINE kb_float4    kb_float4_round      (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_round); }
KB_API_INLINE kb_float4    kb_float4_trunc      (const kb_float4 a)                                { return (kb_float4) ELEMWISE_OP1_T4(kb_float_trunc); }
KB_API_INLINE kb_float     kb_float4_dot        (const kb_float4 a, const kb_float4 b)             { return ELEMWISE_COMB_OP2_T4(kb_float_mul, +); }
KB_API_INLINE bool         kb_float4_equal      (const kb_float4 a, const kb_float4 b)             { return ELEMWISE_COMB_OP2_T4(kb_float_equal, &&); }
...
KB_API        kb_quat       kb_quat_norm        (const kb_quat a);
KB_API_INLINE kb_quat       kb_quat_neg         (const kb_quat a)                                  { return (kb_quat) ELEMWISE_OP1_T4(kb_float_neg); }
KB_API_INLINE kb_quat       kb_quat_add         (const kb_quat a, const kb_quat b)                 { return (kb_quat) ELEMWISE_OP2_T4(kb_float_add); }
KB_API_INLINE kb_quat       kb_quat_sub         (const kb_quat a, const kb_quat b)                 { return (kb_quat) ELEMWISE_OP2_T4(kb_float_sub); }
KB_API_INLINE kb_quat       kb_quat_scale       (const kb_quat a, const kb_float f)                { return (kb_quat) ELEMWISE_OP1_F_T4(kb_float_mul, f); }
KB_API_INLINE kb_quat       kb_quat_lerp        (const kb_quat a, const kb_quat b, const kb_float v)     { return kb_quat_norm((kb_quat) ELEMWISE_OP2_F_T4(kb_float_lerp, v)) ; }
KB_API_INLINE kb_float      kb_quat_dot         (const kb_quat a, const kb_quat b)                 { return ELEMWISE_COMB_OP2_T4(kb_float_mul, +); }
KB_API_INLINE bool          kb_quat_equal       (const kb_quat a, const kb_quat b)                 { return ELEMWISE_COMB_OP2_T4(kb_float_equal, &&); }
