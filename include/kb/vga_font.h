...
#if KB_VGA_FONT_SMALL

static const uint32_t vga_font_width  = 8;
static const uint32_t vga_font_height = 8;
static const uint32_t vga_font_chars  = 256;

static const uint8_t vga_font[vga_font_chars * vga_font_height] = {
...
static const uint32_t vga_font_width  = 8;
static const uint32_t vga_font_height = 16;
static const uint32_t vga_font_chars  = 256;
