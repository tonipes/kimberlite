...
KB_API void* kb_alloc    (kb_allocator* alloc, size_t size, size_t align);
KB_API void* kb_realloc  (kb_allocator* alloc, void* ptr, size_t size, size_t align);
KB_API void  kb_free     (kb_allocator* alloc, void* ptr);
...
#define KB_FREE(alloc, ptr)                                 kb_free     (alloc, ptr)
...
#define KB_DEFAULT_FREE(ptr)                                kb_free     (NULL, ptr)

// KB_API void kb_alloc_create_linear  (kb_allocator* dst, size_t capacity, kb_allocator* root);
// KB_API void kb_alloc_linear_reset   (kb_allocator* alloc);
